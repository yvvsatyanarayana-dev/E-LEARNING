...
// ─── DATA ────────────────────────────────────────────────────────
const MY_COURSES = [
  { name:"Operating Systems",code:"CS501",sem:"Sem 5",students:112,lectures:{done:33,total:42},avgAttendance:81,avgScore:74,color:"var(--indigo-l)",badgeStyle:{background:"rgba(91,78,248,.12)",color:"var(--indigo-ll)"},pctColor:"var(--indigo-ll)",pendingGrade:8,icon:<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg> },
  { name:"Database Management Systems",code:"CS502",sem:"Sem 5",students:108,lectures:{done:23,total:38},avgAttendance:76,avgScore:68,color:"var(--teal)",badgeStyle:{background:"rgba(39,201,176,.1)",color:"var(--teal)"},pctColor:"var(--teal)",pendingGrade:14,icon:<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3"/><path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"/></svg> },
  { name:"Computer Architecture",code:"CS503",sem:"Sem 3",students:96,lectures:{done:28,total:36},avgAttendance:88,avgScore:79,color:"var(--violet)",badgeStyle:{background:"rgba(159,122,234,.12)",color:"var(--violet)"},pctColor:"var(--violet)",pendingGrade:3,icon:<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="4" y="4" width="16" height="16" rx="2"/><rect x="9" y="9" width="6" height="6"/><line x1="9" y1="1" x2="9" y2="4"/><line x1="15" y1="1" x2="15" y2="4"/><line x1="9" y1="20" x2="9" y2="23"/><line x1="15" y1="20" x2="15" y2="23"/><line x1="20" y1="9" x2="23" y2="9"/><line x1="20" y1="14" x2="23" y2="14"/><line x1="1" y1="9" x2="4" y2="9"/><line x1="1" y1="14" x2="4" y2="14"/></svg> },
];
            ...
            <div className="content">
              ...
              <div className="panel" style={{animationDelay:"0.07s"}}>
                <div className="panel-hd">
                  <div className="panel-ttl"><IcoBook width={14} height={14} style={{color:"var(--indigo-ll)"}}/> My Courses <span>3 active this semester</span></div>
