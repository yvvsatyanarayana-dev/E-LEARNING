...
export default function AdminCourseManagement() {
  ...
  return (
    <>
        ...
        <div className="main">
          ...
          <main className="content">
            ...
            <div className="greet-row">
              ...
              <p className="greet-sub">47 active courses &nbsp;·&nbsp; 752 total enrollments &nbsp;·&nbsp; Semester 2 — 2024</p>
              ...
              <div className="panel-body">
                <div className="filter-row">
                  <div className="tb-search" style={{ flex:"1", height:"32px" }}>
                    <I n="search" size={13} /><input placeholder="Search courses…" value={searchTerm} onChange={e => setSearchTerm(e.target.value)} />
                  </div>
      ...
      {addCourseModal && (
        <>
          <div className="modal-overlay" onClick={() => setAddCourseModal(false)} />
          <div className="modal" onClick={e => e.stopPropagation()}>
            <div className="modal-header">
              <h2>Add New Course</h2>
              <button className="modal-close" onClick={() => setAddCourseModal(false)}>×</button>
            </div>
