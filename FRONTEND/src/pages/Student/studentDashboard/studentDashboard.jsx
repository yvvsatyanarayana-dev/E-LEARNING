...
function Topbar({ activePage, onHamburger }) {
  ...
  const pageLabel = activePage === ROUTES.ANALYTICS ? "Analytics" : "Dashboard";
  return (
    ...
    <div className={`lucyna-panel ${open ? "open" : ""}`}>
      ...
      <div className="lp-input-row">
        <div className="lp-input-wrap">
          ...
          {input && (
            <button className="lp-clear" onClick={() => setInput("")} aria-label="Clear">
...
function DashboardContent({ onNavigateToAnalytics }) {
  return (
