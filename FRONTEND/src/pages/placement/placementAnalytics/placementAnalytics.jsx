      ...
      <div className="app">
        ...
        <aside className="sidebar">
          ...
          <nav className="sb-nav">
            ...
            <SbLink to="/placementdashboard/ai-quiz" icon={<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" /></svg>} badge="AI" badgeCls="teal">AI Quiz System</SbLink>
        ...
        <div className="main">
          <header className="topbar">
            ...
            <div className="tb-search">
              ...
              <input type="text" placeholder="Search analytics…" style={{}}/>
            </div>
