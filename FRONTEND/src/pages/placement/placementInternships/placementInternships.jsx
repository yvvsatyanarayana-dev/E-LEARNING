        ...
        <aside className="sidebar">
          ...
          <div className="sb-bottom">
            <div className="sb-pri">
              ...
              <div className="sb-pri-sub">AY {dashStats?.academic_year ?? "2024-25"} · {loading?"…":`${internships.length} total`}</div>
        ...
        <div className="main">
          ...
          <div className="content">
            <div className="greet-row">
              <div className="greet-tag"><div className="greet-pip"/><span className="greet-pip-txt">{loading?"Loading…":`${internships.length} Internships · AY ${dashStats?.academic_year ?? "2024-25"}`}</span></div>
