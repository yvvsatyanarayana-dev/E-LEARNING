...
export default function AdminSecurity() {
  ...
  useEffect(() => {
    ...
    const handleHover = () => document.querySelector(".admin-security-page")?.classList.add("c-hover");
    const handleUnhover = () => document.querySelector(".admin-security-page")?.classList.remove("c-hover");
    const handleClick = () => {
      const p = document.querySelector(".admin-security-page");
      p?.classList.add("c-click"); setTimeout(() => p?.classList.remove("c-click"), 200);
    };
    const interactive = document.querySelectorAll("button, a, input, .stat-card, .al-item, .ut-action");
  ...
  return (
    <>
      ...
      <div className="admin-security-page app" ref={pageRef}>
